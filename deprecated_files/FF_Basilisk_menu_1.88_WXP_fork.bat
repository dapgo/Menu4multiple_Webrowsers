...
rem reactos OS included command
CHOICE /C:123456789HQ  "Choose an option:"
rem CHOICE.COM /C:123456789HQ  "Choose an option:"
rem compatible winXP, 
rem choice_w7_32b.exe /C 123456789HQ /M "Choose an option:"
rem not compatible reactOS
ECHO/ 
...
SET NAME2=Serpent(32b/XP) 2018 (Basilisk fork inc. SYNC)	.
SET PATH2BIN=\Serpent201806_wXP\
...
rem winxp CHOICE.COM /C:123456789ABHQ "Choose an option:"
rem reactos
CHOICE /C:123456789ABHQ "Choose an option:"
ECHO/ 
